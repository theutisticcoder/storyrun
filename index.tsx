...
try {
  ...
  if (notificationsEnabled && 'Notification' in window && Notification.permission === 'granted') {
    ...
    new Notification(`📖 Story Segment ${segmentNumber} Ready!`, {
      body: preview,
      vibrate: [200, 100, 200],
      tag: 'story-segment'
    });
...
```
      {!hasStarted && (
        <div className="mb-6">
          ...
          <div className="mt-4 p-4 bg-blue-500/20 rounded-lg border border-blue-300/30">
            <h3 className="text-white font-semibold mb-3">📋 Setup:</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                {notificationsEnabled && (
                  <span className="text-green-300 text-sm">✓ Enabled</span>
                )}
              </div>
      ...
      <div className="mb-4 text-center text-sm text-white/70">
        Status: {gpsStatus}
        {isSpeaking && <span className="ml-2 text-yellow-300">🔊 Speaking...</span>}
      </div>
              ...
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white/70 text-sm">
                    {segment.speed.toFixed(1)} mph • {segment.timestamp}
                  </span>
                </div>
              </div>
